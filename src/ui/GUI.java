...
public class GUI
{
    ...
    public GUI()
    {
        ...
        ImageIcon pawnW = new ImageIcon((path));
        ImageIcon knightW = new ImageIcon(path);
        ImageIcon bishopW = new ImageIcon(path);
        ImageIcon rookW = new ImageIcon(path);
        ImageIcon queenW = new ImageIcon(path);
        ImageIcon kingW = new ImageIcon(path);

        ImageIcon pawnB = new ImageIcon(path);
        ImageIcon knightB = new ImageIcon((path));
        ImageIcon bishopB = new ImageIcon(path);
        ImageIcon rookB = new ImageIcon(path);
        ImageIcon queenB = new ImageIcon(path);
        ImageIcon kingB = new ImageIcon(path);
